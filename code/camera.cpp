...
// What is quaternion rotation and how does it differ from the rotations we have learned about in class?
void Camera::rotateXY (double theta_, double pitch_)
{
	// C: Rotating the camera requires nothing else to be done at the same time, thus this if statement functions like a mutex
