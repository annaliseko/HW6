...
// Q: This whole file has no comments, we are confused as to the functionality of all of the defined methods.

RayFileInstance::RayFileInstance ()
    : ShapeGroup () // C: This is the base class constructor that RayFileInstances are derived from.
{
    rayfile = NULL;
    root    = NULL;
}
