...
// There are many ways to initialize an image. We briefly explained what each constructor does and how they are different from each other.
// This one is the default constructor
Image::Image ()
{
    width    = 0;
    height   = 0;
...
// This image passes through a width and height
...
// This image passes through a width and height as well, but you can also pass through channels
...
// This initialization is similar to the previous two, but you can also pass through bits.
...
// This initialization is based off of a file
...
// This is a copy constructor that copies an image 
...
// Q: Why are there 2 versions of every type of getPixel functions? One with an underscore at the end, that seems to be doing different things.
...
int Image::write (std::string filename)
{
    ...
    if (strncmp(ext, ".bmp", 4) == 0)
    {
        ...
        return writeBMP(filename.c_str());
    }
    else
        return -1;
}
