...
// C: This class is the base class for both shapes and groups, in the case of rayfiles, it uses the group, in the case of the shape derived class, it is a shape.
