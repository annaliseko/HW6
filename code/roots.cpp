...
/*
 * C: This function seems to be a simplified version of quadratic solving from hw2, and doesn't consider error propogation from small results.
 * -- Prat & Brendan
 */

/* This is new syntax for us but we figured that coeffs is an array of 3 doubles and results is an array of 2 doubles.
 *  Coeffs are the three coefficients in a quadratic formula, a, b, and c such that (-b+-sqrt(b^2 - 4ac))/2a
 *  The two roots are put into the results array.
 * -- Holly & Mahlet
 */
